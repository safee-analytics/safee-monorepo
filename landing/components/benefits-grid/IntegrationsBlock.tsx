...
import { SiGithub, SiPlanetscale, SiPrisma, SiSupabase, SiZapier } from "react-icons/si";
...
export const IntegrationsBlock = () => (
  <Block className="col-span-3 overflow-hidden md:col-span-2">
    ...
    <CardSubtitle>
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus cum earum facilis sint ducimus nulla
      magnam eveniet a reprehenderit veniam.
    </CardSubtitle>
