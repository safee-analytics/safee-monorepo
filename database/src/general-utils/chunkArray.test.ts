...
describe("chunkArray", () => {
  ...
  it("work with any type", () => {
    expect(chunkArray(["a", "b", "c", "d"], 3)).toEqual([["a", "b", "c"], ["d"]]);
  });

  it("should error with negative chunk size", () => {
    expect(() => chunkArray([1, 2, 3, 4], -1)).toThrow();
  });

  it("should error with 0 chunk size", () => {
    expect(() => chunkArray([1, 2, 3, 4], 0)).toThrow();
  });

  it("should error with decimal chunk size", () => {
