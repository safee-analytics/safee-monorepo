...
ALTER TABLE "jobs"."job_schedules" ADD CONSTRAINT "job_schedules_job_definition_id_job_definitions_id_fk" FOREIGN KEY ("job_definition_id") REFERENCES "jobs"."job_definitions"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "jobs"."jobs" ADD CONSTRAINT "jobs_job_definition_id_job_definitions_id_fk" FOREIGN KEY ("job_definition_id") REFERENCES "jobs"."job_definitions"("id") ON DELETE cascade ON UPDATE cascade;
