export { OdooDatabaseService, type OdooDatabaseServiceDependencies, type OdooConfig } from "./database.service.js";
...
export type { OdooLead, OdooStage, OdooContact, OdooActivity, OdooTeam, OdooLostReason } from "./crm.service.js";
export {
  OdooHRService,
  parseEmployeeType,
  parseGender,
