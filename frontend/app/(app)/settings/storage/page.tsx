        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Configure your storage solution for document management
            </p>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  <HardDrive className={`w-5 h-5 ${storageMode === "managed" ? "text-blue-600" : "text-gray-500"}`} />
                  <h3 className={`font-semibold ${storageMode === "managed" ? "text-blue-900" : "text-gray-900"}`}>
                    Managed Storage
                  </h3>
                </div>
                <p className="text-sm text-gray-600">We provide secure cloud storage with automatic backups</p>
              </button>
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  <Server className={`w-5 h-5 ${storageMode === "custom" ? "text-blue-600" : "text-gray-500"}`} />
                  <h3 className={`font-semibold ${storageMode === "custom" ? "text-blue-900" : "text-gray-900"}`}>
                    Custom NAS/Storage
                  </h3>
                </div>
