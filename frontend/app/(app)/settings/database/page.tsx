            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  <Database className={`w-5 h-5 ${dbMode === "managed" ? "text-blue-600" : "text-gray-500"}`} />
                  <h3 className={`font-semibold ${dbMode === "managed" ? "text-blue-900" : "text-gray-900"}`}>
                    Managed Database
                  </h3>
                </div>
                <p className="text-sm text-gray-600">We handle all database management, backups, and maintenance</p>
              </button>
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  <HardDrive className={`w-5 h-5 ${dbMode === "custom" ? "text-blue-600" : "text-gray-500"}`} />
