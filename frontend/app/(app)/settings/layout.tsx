...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  const settingsLinks: SettingLink[] = [
    ...
    { href: '/settings/notifications', label: t.common.notifications || 'Notifications', icon: Bell, restricted: false },
                ...
                return (
                  <Link key={link.href} href={link.href}>
                    ...
                    >
                      ...
                      {link.restricted && (
                        <Lock className="w-3 h-3 text-gray-400" title="Admin only" />
                      )}
                    </motion.div>
                  </Link>
                )
