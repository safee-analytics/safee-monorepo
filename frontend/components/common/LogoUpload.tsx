      ...
      <div className="space-y-4">
        ...
        {previewUrl && (
          <div className="relative w-48 h-48 border-2 border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden bg-white dark:bg-gray-800 flex items-center justify-center">
            <img src={previewUrl} alt="Company Logo" className="max-w-full max-h-full object-contain p-4" />
            {isUploading && (
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
          <h4 className="text-sm font-medium text-blue-900 dark:text-blue-100 mb-2">Logo Guidelines</h4>
