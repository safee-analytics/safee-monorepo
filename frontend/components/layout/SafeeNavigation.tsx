      ...
      <div className="px-6 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          <Link href="/" className="flex items-center gap-3 flex-shrink-0">
            ...
            <span className="text-lg font-semibold text-gray-900 dark:text-gray-100 hidden sm:block">Safee Analytics</span>
          </Link>
          ...
          <div className="flex-1 max-w-2xl">
            <div className="relative">
              <Search
                className={`absolute ${locale === "ar" ? "right-4" : "left-4"} top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 dark:text-gray-500`}
              />
              <input
                type="text"
                value={searchQuery}
                ...
                className={`w-full ${locale === "ar" ? "pr-12 pl-4" : "pl-12 pr-4"} py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-safee-500 focus:bg-white dark:focus:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 transition-all`}
              />
            </div>
          </div>
