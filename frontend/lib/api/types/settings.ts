...
export interface paths {
    ...
    "/subscriptions/{subscriptionId}": {
        ...
        options?: never;
        head?: never;
        /** @description Update subscription plan or seats */
    ...
    "/organizations/slugs/next": {
        ...
        /**
         * @description Get the next available slug for an organization name
         *     Returns the slug with an incremented number if conflicts exist
         */
        get: operations["GetNextSlug"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/onboarding/status": {
        ...
        /** @description Get current onboarding status and next step for the user */
    ...
    "/onboarding/upgrade-plan": {
        ...
        get?: never;
        put?: never;
        /** @description Upgrade from free plan to paid plan during onboarding */
        post: operations["UpgradePlan"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/onboarding/skip-upgrade": {
        ...
        get?: never;
        put?: never;
        /** @description Skip upgrade and continue with free plan */
        post: operations["SkipUpgrade"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface operations {
    ...
    GetNextSlug: {
        parameters: {
            query: {
                /** @description The base slug to check (e.g., "acme") */
                baseSlug: string;
            };
            header?: never;
            path?: never;
    ...
    UpgradePlan: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpgradePlanRequest"];
            };
        };
        responses: {
    ...
    SkipUpgrade: {
        ...
        requestBody?: never;
        responses: {
            /** @description Continuing with free plan */
            200: {
                headers: {
                    [name: string]: unknown;
                };
