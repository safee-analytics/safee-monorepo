...
export function RegisterRoutes(app) {
  ...
  app.post(
    ...
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares(PayrollController),
    ...fetchMiddlewares(PayrollController.prototype.createPayrollRecord),
    async function PayrollController_createPayrollRecord(request, response, next) {
      // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
      let validatedArgs = [];
      try {
        validatedArgs = templateService.getValidatedArgs({
  ...
  app.post(
    ...
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares(PayrollController),
    ...fetchMiddlewares(PayrollController.prototype.processPayroll),
    async function PayrollController_processPayroll(request, response, next) {
      // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
      let validatedArgs = [];
      try {
        validatedArgs = templateService.getValidatedArgs({
  ...
  app.post(
    ...
    async function AuthController_logout(request, response, next) {
      // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
      let validatedArgs = [];
      try {
        validatedArgs = templateService.getValidatedArgs({
  ...
  app.post(
    ...
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares(AccountController),
    ...fetchMiddlewares(AccountController.prototype.createAccount),
    async function AccountController_createAccount(request, response, next) {
      // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
      let validatedArgs = [];
      try {
        validatedArgs = templateService.getValidatedArgs({
