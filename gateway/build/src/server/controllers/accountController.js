...
let AccountController = class AccountController extends Controller {
  async getAccounts(_type) {
...
AccountController = __decorate([Route("accounts"), Tags("Accounting")], AccountController);
