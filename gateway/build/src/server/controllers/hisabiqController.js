...
], HisabiqController.prototype, "getInvoices", null);
__decorate([
    Post("invoices"),
    Security("jwt"),
    ...
    __metadata("design:returntype", Promise)
], HisabiqController.prototype, "createInvoice", null);
__decorate([
    Get("accounts"),
    Security("jwt"),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", Promise)
], HisabiqController.prototype, "getAccounts", null);
HisabiqController = __decorate([
    Route("hisabiq"),
