...
export function RegisterRoutes(app) {
    ...
    app.post("/api/v1/payroll/generate", authenticateMiddleware([{ jwt: [] }]), ...fetchMiddlewares(PayrollController), ...fetchMiddlewares(PayrollController.prototype.generatePayroll), async function PayrollController_generatePayroll(request, response, next) {
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
            validatedArgs = templateService.getValidatedArgs({
    ...
    app.post("/api/v1/auth/refresh", ...fetchMiddlewares(AuthController), ...fetchMiddlewares(AuthController.prototype.refresh), async function AuthController_refresh(request, response, next) {
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
            validatedArgs = templateService.getValidatedArgs({
