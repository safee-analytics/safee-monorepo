...
export class ApiError extends Error {
    ...
    context;
    code;
    constructor(message, statusCode = 500, context, code) {
        super(message);
        this.name = "ApiError";
...
export async function server({ logger, redis, drizzle, pool: _pool }) {
    ...
    initServerContext({ drizzle, logger: logger, redis });
    app.use(helmet());
