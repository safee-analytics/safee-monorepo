...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/api/v1/payroll',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(PayrollController)),
            ...(fetchMiddlewares<RequestHandler>(PayrollController.prototype.createPayrollRecord)),

            async function PayrollController_createPayrollRecord(request: ExRequest, response: ExResponse, next: any) {
        ...
        app.get('/api/v1/hisabiq/invoices',
            authenticateMiddleware([{"jwt":[]}]),
        ...
        app.post('/api/v1/hisabiq/invoices',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(HisabiqController)),
        ...
        app.get('/api/v1/hisabiq/accounts',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(HisabiqController)),
